...
def UploadFile(request):
    ...
    random_str = ""
    for i in range(0, 8):
        random_str += random.sample(string.letters+string.digits, 1)[0]
    OutputFile = "Article/" + upload_original_name + "_" + random_str + upload_original_ext
    ...
    #返回数据
    return_info = {
        'url': urllib.basejoin('/media/img/', OutputFile) ,                # 保存后的文件名称
