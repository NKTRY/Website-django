    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(default='', max_length=20, verbose_name='\u5185\u5bb9\u5206\u7c7b', choices=[('dt', '\u793e\u56e2\u52a8\u6001'), ('zl', '\u793e\u56e2\u8d44\u6599')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField(verbose_name='\u6587\u7ae0\u94fe\u63a5', blank=True)),
                ('category', models.ForeignKey(default='', verbose_name='\u5206\u7c7b', to='frontend.SecondaryMenu')),
                ('push', models.OneToOneField(verbose_name='\u63a8\u9001\u6587\u7ae0\u6807\u9898', to='frontend.Article')),
            ],
            options={
                'verbose_name': '\u9996\u9875\u5e7b\u706f\u7247',
        ...
        migrations.AddField(
            model_name='activity',
            name='category',
            field=models.ForeignKey(default='', verbose_name='\u5206\u7c7b', to='frontend.SecondaryMenu'),
            preserve_default=True,
        ),
    ]
