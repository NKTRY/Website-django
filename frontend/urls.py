...
from frontend.views import index, main_menu, secondary_menu, secondary_menu_all, main_menu_all, search, content

urlpatterns = patterns('',
    url(r'^$', index, name='index'),
    url(r'^s/(?P<main>\w+)/$', main_menu, name="main_menu"),
    url(r'^a/(?P<main>\w+)/$', main_menu_all, name="main_menu_all"),
